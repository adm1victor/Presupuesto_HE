...
```ts
import { useCreateUser, useGetTransactionsForUser, useCreateBudget, useListCategoriesForUser } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useCreateBudget(createBudgetVars);

const { data, isPending, isSuccess, isError, error } = useListCategoriesForUser();
...
```js
import { createUser, getTransactionsForUser, createBudget, listCategoriesForUser } from '@dataconnect/generated';
...
// Operation ListCategoriesForUser: 
